...
const getRect = function(context, selector, needAll = false, useH5Origin = false) {
  return new Promise((resolve2, reject) => {
    index.createSelectorQuery().in(context)[needAll ? "selectAll" : "select"](selector).boundingClientRect((rect) => {
      if (rect) {
        resolve2(rect);
      } else {
        reject(rect);
...
const highLight = function(label, keyword) {
...
exports.ISOLATED_RELATION_KEY = ISOLATED_RELATION_KEY;
